package com.rafaelkpatricio.workshopmongo.config;
...
import com.rafaelkpatricio.workshopmongo.dto.AuthorDTO;
import com.rafaelkpatricio.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		maria.getPosts().addAll(Arrays.asList(post1,post2)); // Associações dos posts
